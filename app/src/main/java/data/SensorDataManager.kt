...
class SensorDataManager(context: Context, dataStore: DataStore<Preferences>) {
    ...
    fun preprocessSensorData(accelerometerData: MutableMap<Long, FloatArray>, gyroscopeData: MutableMap<Long, FloatArray>) {
        ...
        combineSensorData(filteredGyroData, filteredAccData)
    }
    ...
    private fun combineSensorData(gyroData: MutableMap<Long, FloatArray>, accData: MutableMap<Long, FloatArray>): MutableMap<Long, FloatArray> {
        ...
        for (timestamp in commonTimestamps) {
            ...
            combinedValues[0] = gyroData[timestamp]!![0]
            combinedValues[1] = gyroData[timestamp]!![1]
            combinedValues[2] = gyroData[timestamp]!![2]
            combinedValues[3] = accData[timestamp]!![0]
            combinedValues[4] = accData[timestamp]!![1]
            combinedValues[5] = accData[timestamp]!![2]
